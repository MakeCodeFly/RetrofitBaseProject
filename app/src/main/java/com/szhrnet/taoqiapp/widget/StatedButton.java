...
public class StatedButton extends Button {
    ...
    public StatedButton(Context context, AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.buttonStyle);
    }

    public StatedButton(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.StatedButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.StatedButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.StatedButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.StatedButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.StatedButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.StatedButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.StatedButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.StatedButton_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.StatedButton_radius, 0);
        mRound = a.getBoolean(R.styleable.StatedButton_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.StatedButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.StatedButton_strokeDashWidth, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.StatedButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.StatedButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.StatedButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.StatedButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.StatedButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.StatedButton_unableStrokeColor, 0);
        setStroke();
