...
public class CustomAlbumSelectAdapter extends CustomGenericAdapter<Album> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RequestOptions requestOptions = new RequestOptions()
                .centerCrop()
                .placeholder(R.drawable.image_placeholder);//指定加载失败显示的图片资源
        Glide.with(context).load(arrayList.get(position).cover).apply(requestOptions).into(viewHolder.imageView);
